...
const AdminEditHotel = () => {
    ...
    const fetchHotelData = async () => {
        try {
            const response = await axios.get(
                `${import.meta.env.VITE_API_BASE_URL}/admin/hotels/${id}`,
                { withCredentials: true }
            );
    ...
    const removeImage = (index) => {
        // For existing images from the database
        if (index < hotelData.imageUrls.length) {
            const updatedImageUrls = [...hotelData.imageUrls];
        ...
        // For newly added images
            ...
            const newImageIndex = index - hotelData.imageUrls.length;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const hotelDataToSubmit = {
                ...hotelData,
                imageUrls: [...hotelData.imageUrls, ...uploadedImageUrls],
            };
